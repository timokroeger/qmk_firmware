...
[0] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
       KC_LGUI, LCTL_T(KC_TAB), KC_SPC, LALT_T(KC_ENT), RCTL_T(KC_DEL), RSFT_T(KC_BSPC), LT(1, KC_ESC), KC_NO
),
[1] = LAYOUT(
    ...
    RESET,   _______, _______, _______, _______, _______,   KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______,
